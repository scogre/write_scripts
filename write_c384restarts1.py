...
path2ensmean='/scratch3/BMC/gsienkf/Scott.Gregory/CHGRES/experiments/2003122800_restarts1/C384_ensmean/'
...
for memno in range(10):
   ...
   if len(memstr)<2:
      ...
      memtext='mem0'+memstr
   path2ens='/scratch3/BMC/gsienkf/Scott.Gregory/CHGRES/experiments/2003122800_restarts1/C384_'+memtext+'/'
